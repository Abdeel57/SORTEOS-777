        ...
        if (isTableError) {
          ...
          await this.prisma.$executeRaw`
            INSERT INTO "settings" (
              ...
              ${settingsData.titleColor},
              ${settingsData.subtitleColor},
              ${settingsData.descriptionColor},
            ...
            ON CONFLICT ("id") DO UPDATE SET
              ...
              "titleColor" = EXCLUDED."titleColor",
              "subtitleColor" = EXCLUDED."subtitleColor",
              "descriptionColor" = EXCLUDED."descriptionColor",
